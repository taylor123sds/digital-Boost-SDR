    ...
    try {
      ...
      setStats({
        ...
        leadsByStage: [
          ...
          { stage: 'Negociação', count: 45 },
          { stage: 'Fechado', count: 156 },
        ],
        recentActivity: [
          { id: '1', type: 'message', description: 'Nova mensagem de João Silva', timestamp: new Date().toISOString() },
          ...
          <Card hover className="cursor-pointer group">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400">Inicie uma campanha de prospecção</p>
              </div>
              <ArrowUpRight className="text-gray-400 group-hover:text-cyan transition-colors" />
            </div>
          </Card>
          <Card hover className="cursor-pointer group">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400">Analise métricas detalhadas</p>
              </div>
              <ArrowUpRight className="text-gray-400 group-hover:text-cyan transition-colors" />
            </div>
          </Card>
