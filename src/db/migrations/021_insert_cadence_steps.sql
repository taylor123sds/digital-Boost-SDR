-- Migration 021: Inserir Passos da Cadência de 15 Dias
...
INSERT INTO cadence_steps (id, cadence_id, day, step_order, name, description, channel, action_type, send_time, template_variant, content, condition_type, skip_if_responded) VALUES
...
-- D1 - Email de Apoio
INSERT INTO cadence_steps (id, cadence_id, day, step_order, name, description, channel, action_type, send_time, delay_hours, subject, content, condition_type, skip_if_responded) VALUES
...
INSERT INTO cadence_steps (id, cadence_id, day, step_order, name, description, channel, action_type, send_time, content, condition_type, skip_if_responded) VALUES
...
INSERT INTO cadence_steps (id, cadence_id, day, step_order, name, description, channel, action_type, content, condition_type, skip_if_responded) VALUES
...
INSERT INTO cadence_steps (id, cadence_id, day, step_order, name, description, channel, action_type, send_time, subject, content, condition_type, skip_if_responded) VALUES
...
INSERT INTO response_templates (id, name, response_type, trigger_keywords, template_content, next_action) VALUES
